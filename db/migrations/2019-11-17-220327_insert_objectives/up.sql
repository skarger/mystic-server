...
('{client_name} will independently identify and seek the definitions of unfamiliar words to add to {client_name} vocabulary notebook in 80% of opportunities across the treatment period.'),
...
('{client_name} will maintain a positive attitude when offering clarification of {client_name} misunderstood message in 80% of opportunities across the treatment period.'),
...
('During a 10-minute catch-up chat, {client_name} will ask {client_name} conversation partner three questions given visual reminders across four consecutive sessions.'),
...
('Given intermittent prompting, {client_name} will appropriately introduce {client_name} conversational contribution ("I want to tell you something" vs. "I want to ask you something") in 80% of opportunities across the treatment period.'),
...
('{client_name} will begin to repair miscommunications as they arise by answering clarifying questions, saying {client_name} message a different way, giving more information, or showing visually.'),
('{client_name} will change topics using explicit verbal strategies (That reminds me… Speaking of…), in 80% of opportunities across therapy period.'),
...
('{client_name} will describe a situation with sufficient context for {client_name} listener to follow in four of five consecutive opportunities.'),
...
('{client_name} will independently notice when {subject} doesn''t have the attention of {client_name} intended listener and take appropriate steps to gain their attention (e.g., say name, tap on shoulder/arm) in 80% of opportunities across the treatment period.'),
...
('{client_name} will independently resolve small disagreements with {client_name} peer in 80% of opportunities across the treatment period.'),
...
('{client_name} will notice when {subject} doesn''t have the attention of {client_name} intended listener and take appropriate steps to gain their attention (e.g., say name, tap on shoulder/arm) in 80% of opportunities across the treatment period.'),
...
('{client_name} will repair miscommunications as they arise by answering clarifying questions, saying {client_name} message a different way, giving more information, or showing visually in 80% of opportunities across the treatment period.'),
...
('{client_name} will use strategies to help {reflexive}self self-regulate (e.g., feeling {reflexive} heart beating, taking deep breaths, taking a break, getting a drink of water, etc). By the end of the treatment period, given visual and verbal support, {client_name} will choose a strategy and implement it when needed.'),
