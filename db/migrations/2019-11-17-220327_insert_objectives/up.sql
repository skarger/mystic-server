...
('Following reinforcement of targeted concepts, {client_name} will accurately follow directions with 4 to 6 critical elements of information including temporal and/or spatial terms (allowing for one spontaneous request for repetition) at least 80% of opportunities across three sessions.'),
('Given a context/category but limited visual support, {client_name} will name described objects at least 75% of opportunities across 2 sessions.'),
('Given a context/category but limited visual support, {client_name} will name described objects at least 75% of opportunities across 3 sessions.'),
...
('Given a visually supported initial review/reminder and then nonverbal cues only as needed, {client_name} will use "whole body listening" during direction following activities for at least 5/6 turns across three sessions.'),
...
('In response to a descriptive adjective, {client_name} will name or indicate 3 to 5 items which fit that description for four sessions during structured activities.'),
...
('{client_name} will respond to bids for attention (e.g., "{client_name}!" "look!") by visually referencing the clinician in 75% of opportunities across 4 of 5 consecutive sessions.'),
...
('Given an initial model, {client_name} will appropriately use "does" and "does not" in expected contexts within a structured activity with 80% accuracy in each of four sessions.'),
...
('Given indirect modeling and scaffolding as needed, {client_name} will provide verbal descriptions which include a category name and one or more distinguishing features at least 80% of opportunities across two sessions.'),
...
('Given intermittent verbal prompts, {client_name} will use the sentence transition "so" with 80% accuracy in structured activities in each of four sessions.'),
...
('When not able to efficiently retrieve specific vocabulary, {client_name} will describe {possessive_adjective} target sufficiently to repair the miscommunication in 80% of opportunities across the treatment period.'),
...
('{client_name} will establish consistent use of targeted morphemes (plural, possessive, "is") in spontaneous speech, as measured by language samples, by the end of the progress period.'),
...
('{client_name} will use "really" in 80% of expected contexts in {possessive_adjective} spontaneous language across three sessions.'),
...
('{client_name} will name 5 items in a given category once per session across 3 consecutive sessions.'),
('{client_name} will name 5 items within a given category twice per session across 3 consecutive sessions.'),
('{client_name} will name 5-10 items in a category (e.g., animals, things that are round, things in a classroom) at least twice per session for 4 of 5 sessions.'),
('{client_name} will name an object given 3 distinguishing features (e.g., function, appearance, location) in 4 of 5 opportunities across 3 consecutive sessions.'),
('{client_name} will name at least 5 items that share a common part (e.g., items with wheels, items with buttons) once per session across three consecutive sessions'),
('{client_name} will name at least 5 words that start with a target sound once per session across three consecutive sessions.'),
...
('During a 10-minute activity, {client_name} will produce /l/ in all word positions in {possessive_adjective} spontaneous speech with 80% accuracy for three consecutive sessions.'),
...
('Following imitative practice {client_name} will spontaneously produce "th" in all word positions within structured phrases and sentences at least 80% of opportunities across three sessions.'),
...
('Given intermittent cueing, {client_name} will produce prevocalic /r/ and /r/ blends in {possessive_adjective} spontaneous speech with 80% accuracy for three consecutive sessions.'),
...
('{client_name} will produce /l/ in {possessive_adjective} connected speech during a 15-minute activity with 80% accuracy across three sessions.'),
('{client_name} will produce /l/ in {possessive_adjective} connected speech with 80% accuracy across three sessions.'),
('{client_name} will produce /l/ in {possessive_adjective} spontaneous speech with 80% accuracy for three consecutive sessions.'),
...
('{client_name} will participate in discussions about {possessive_adjective} speech and strategy use in three of four opportunities over the treatment period.'),
